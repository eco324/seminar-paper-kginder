...
- **Meal_number:** Rotating menu cycle. 
...
library(readr)
Compost_Tracker_6_0 <- read_csv("Raw Data Seminar Paper/Compost Tracker 6.0.csv")
View(Compost_Tracker_6_0)


Compost_data <- read_csv("Raw Data Seminar Paper/Compost Tracker 6.0.csv")  %>%
...
The data was coding correctly for the variables with numbers to be codded as numerical variables.  The only categorical variable in the data was Day of the week.
