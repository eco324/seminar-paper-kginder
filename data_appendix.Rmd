...
```{r}
#renaming vairalbles from the importable data
...
For the dataset Compost_data, the variable house was hidden within the variable names of other variables.  Because much of the analysis involves comping King house to Cutter house, house needed to be able to stand alone. 
```{r, Creating the Variable House}
