...
To obtain a copy of this data set please contact Susan Sayre at ssayre@smith.edu. Due to the COVID-19 pandemic the spring semester 2020 was moved to remote learning and the dinning halls were closed.  The data analysed below is artificially created. Numbers are based off of one dinning hall over the course of a week, but do not represent the impact of the study.
